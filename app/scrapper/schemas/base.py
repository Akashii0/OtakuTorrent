...
class SearchResult(BaseModel):
    ...
    link: HttpUrl = Field(
        ...,
        examples=[
            "https://gogoanime.so/category/naruto",
            "https://gogoanime.so/category/naruto-shippuden",
        ],
    )
...
class AnimeMetadataResponse(BaseModel):
    poster_url: HttpUrl = Field(
        ...,
        examples=[
            "https://gogoanime.so/anime/naruto/cover",
            "https://gogoanime.so/anime/naruto-shippuden/cover",
        ],
    )
    summary: str = Field(
        ...,
        examples=[
            ...
            "Naruto Shippuden is a continuation of the original Naruto series.",
        ],
    )
...
class DownloadLinkResponse(BaseModel):
    direct_download_links: List[HttpUrl] = Field(
        ..., examples=["https://gogoanime.so/download/naruto-shippuden-episode-1", "https://gogoanime.so/download/naruto-shippuden-episode-2"]
    )
...
class DubAvailabilityResponse(BaseModel):
    ...
    dub_link: HttpUrl = Field(
        ...
        examples=[
            ...
            "https://gogoanime.so/category/naruto-shippuden-dub",
        ],
    )
